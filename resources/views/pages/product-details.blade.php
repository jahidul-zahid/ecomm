        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                  ...
                  <button class="primary-btn" type='submit' style="border: 0ch">ADD TO CARD</button>
                    </form>
                    ...
                    <div class="product__item__pic set-bg" data-setbg="{{asset($product->image_one)}}">
                        <ul class="product__item__pic__hover">
                            ...
                            <form action="{{url('add/to-cart/'.$product->id)}}" method="POST">
                                @csrf
                                <input type="hidden" name='price' value="{{$product->price}}">
                            <li><button type='submit' style="border: 0ch"><a href=""><i class="fa fa-shopping-cart"></i></a></button></li>
                            </form>
                        </ul>
                    </div>
