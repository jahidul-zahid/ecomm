                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="shoping__cart__item">
                                    <img style="height: 70px; width:70px;" src="{{asset($cart->product->image_one)}}" alt="">
                                ...
                                <td class="shoping__cart__total">
                                    $ {{$cart->price* $cart->product_quantity}}
                                </td>
            ...
            <div class="col-lg-6">
                <div class="shoping__checkout">
                    ...
                    <ul>
                        ...
                        ({{$subtotal*session()->get('coupon')['coupon_discount']/100}} tk )</span></li>

                        <li>Total  <span>${{$subtotal-$subtotal*session()->get('coupon')['coupon_discount']/100}}</span></li>
                        </span></li>
