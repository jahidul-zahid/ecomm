                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                   ...
                                   <a href="{{url('admin//delete/'.$row->id) }}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>

                                   @if ($row->status==1)

                                   <a href="{{url('admin//inactive/'.$row->id) }}" class="btn btn-sm btn-danger"><i class="fa fa-arrow-down"></i></a>

                                    @else
                                   <a href="{{url('admin//active/'.$row->id) }}" class="btn btn-sm btn-success"><i class="fa fa-arrow-up"></i></a>
                                    @endif
                                </td>
